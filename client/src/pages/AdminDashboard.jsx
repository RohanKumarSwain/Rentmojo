    ...
    "adminToken"
        ...
        const res =
          await axios.get(
            ...
            "https://rentmojo-lahm.onrender.com/admin/analytics",
    ...
    "adminToken"
        ...
        const response =
          await axios.get(
           ...
           "https://rentmojo-lahm.onrender.com/admin/orders",
  ...
  localStorage.getItem(
    "adminToken"
        ...
        await axios.delete(
          ...
          `https://rentmojo-lahm.onrender.com/products/${id}`,
...
const updateStatus = async (
  ...
  try {
    ...
    await axios.put(
      ...
      `https://rentmojo-lahm.onrender.com/admin/orders/${orderId}`,
